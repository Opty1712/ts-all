...
export const BOOKS_DEFAULT: Array<Book> = (booksMockJson as Array<RawBook>).map(
  adaptBookFromBackend,
);

export const BOOKS_ALTERNATIVE: Array<Book> = (
  booksAlternativeMockJson as Array<RawBook>
).map(adaptBookFromBackend);
